...
#        org = ""
    ...
    timeout_cnt = 0
    result_urls = set() 
    while len(result_urls) == 0 and timeout_cnt <= 25:
        try:
            search_url = 'https://fofa.info/result?qbase64='
            search_txt = f'\"udpxy\" && city=\"{province}\" && org=\"{org}\"'
                # 将字符串编码为字节流
            ...
            response = requests.get(search_url, timeout=240)
            # 处理响应
