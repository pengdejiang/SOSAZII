...
with open("SOSAZI-over.txt",'w', encoding='utf-8') as file:   #新建输出文件
    ...
    for line in lines:  #查找每一行
		#如果IP当中包含下面数字
        if line.find("//27.10") != -1 or line.find("//220.176.218") != -1 or line.find("//171.221.129") != -1 or line.find("//118.122.111") != -1 or line.find("//27.191.71") != -1 or line.find("//175.11.171") != -1 or line.find("//220.176.218") != -1 or line.find("//117.43.80") != -1 or line.find("//182.139.152") != -1 or line.find("//118.122.111") != -1 or line.find("//118.112.60") != -1 or line.find("//27.191.71") != -1 or line.find("//122.232.188") != -1 or line.find("//125.71.44") != -1 or line.find("//122.234.77") != -1 or line.find("//122.232.188") != -1 or line.find("//14.105.105.35") != -1 or line.find("//27.191.71.248") != -1 or line.find("//144.255.40.160") != -1 or line.find("//140.250.221") != -1 or line.find("//223.242.146") != -1 or line.find("//182.139.215") != -1 or line.find("//182.150.168") != -1 or line.find("//120.32.11") != -1 or line.find("//113.86.204.209") != -1 or line.find("//110.185.44") != -1 or line.find("///61.157.92.168") != -1 or line.find("//220.175.145") != -1 or line.find("//117.25.38") != -1 or line.find("//125.82.171") != -1 or line.find("//117.12.148") != -1 or line.find("//183.5.92") != -1 or line.find("//117.66.231") != -1 or line.find("//36.47.83") != -1 or line.find("//115.221.95") != -1 or line.find("//113.120.108") != -1 or line.find("//115.193.167") != -1 or line.find("//117.28.112") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1:    #在or后面添加更多需要删除的//xxx地址-注意冒号结尾-中间没有冒号
