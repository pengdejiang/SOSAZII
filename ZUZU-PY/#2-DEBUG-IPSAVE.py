...
file_paths = ["天津联通.txt", "山西联通.txt","安徽电信.txt", "河南联通.txt", "河南电信.txt", "福建电信.txt", "江苏电信.txt", "贵州电信.txt", "四川联通.txt", "四川电信.txt", "重庆联通.txt", "重庆电信.txt","山东电信.txt","广东电信.txt","广西电信.txt","江西电信.txt","河北电信.txt","浙江电信.txt","湖北电信.txt","湖南电信.txt","辽宁联通.txt","陕西电信.txt"]  #替换为实际的文件路径列表
...
file_paths = ["天津联通.txt", "山西联通.txt","安徽电信.txt", "河南联通.txt", "河南电信.txt", "福建电信.txt", "江苏电信.txt", "贵州电信.txt", "四川联通.txt", "四川电信.txt", "重庆联通.txt", "重庆电信.txt","山东电信.txt","广东电信.txt","广西电信.txt","江西电信.txt","河北电信.txt","浙江电信.txt","湖北电信.txt","湖南电信.txt","辽宁联通.txt","陕西电信.txt","JIEXI.txt"]  #替换为实际的文件路径列表
...
with open("SOSAZI-over.txt",'w', encoding='utf-8') as file:   #新建输出文件
    ...
    for line in lines:  #查找每一行
		#如果IP当中包含下面数字
        if line.find("//27.10") != -1 or line.find("//220.176.218") != -1 or line.find("//171.221.129") != -1 or line.find("//118.122.111") != -1 or line.find("//27.191.71") != -1 or line.find("//175.11.171") != -1 or line.find("//220.176.218") != -1 or line.find("//117.43.80") != -1 or line.find("//182.139.152") != -1 or line.find("//118.122.111") != -1 or line.find("//118.112.60") != -1 or line.find("//27.191.71") != -1 or line.find("//122.232.188") != -1 or line.find("//125.71.44") != -1 or line.find("//122.234.77") != -1 or line.find("//122.232.188") != -1 or line.find("//14.105.105.35") != -1 or line.find("//27.191.71.248") != -1 or line.find("//144.255.40.160") != -1 or line.find("//140.250.221") != -1 or line.find("//223.242.146") != -1 or line.find("//182.139.215") != -1 or line.find("//182.150.168") != -1 or line.find("//120.32.11") != -1 or line.find("//113.86.204.209") != -1 or line.find("//110.185.44") != -1 or line.find("///61.157.92.168") != -1 or line.find("//59.56.214") != -1 or line.find("//117.25.38") != -1 or line.find("//125.82.171") != -1 or line.find("//117.12.148") != -1 or line.find("//183.5.92") != -1 or line.find("//117.66.231") != -1 or line.find("//36.47.83") != -1 or line.find("//115.221.95") != -1 or line.find("//113.120.108") != -1 or line.find("//115.193.167") != -1 or line.find("//117.28.112") != -1 or line.find("//117.25.38") != -1 or line.find("//117.67.169") != -1 or line.find("//221.15.251") != -1 or line.find("//117.67.169") != -1 or line.find("//221.15.251") != -1 or line.find("//116.5.168") != -1 or line.find("//175.0.95") != -1 or line.find("//118.248.154") != -1 or line.find("//220.175.144") != -1 or line.find("//118.254.201") != -1 or line.find("//14.154.192") != -1 or line.find("//124.112.208") != -1 or line.find("//182.148.30") != -1 or line.find("//110.185.70") != -1 or line.find("//183.5.97.206") != -1 or line.find("//123.55.112") != -1 or line.find("//222.182.115") != -1 or line.find("//14.117.233") != -1 or line.find("//113.13.242") != -1 or line.find("//59.56.214.134") != -1 or line.find("//58.42.184.132") != -1 or line.find("//58.42.184.132") != -1 or line.find("//220.192.1.40") != -1 or line.find("//27.11.253.19") != -1 or line.find("//27.11.58.239") != -1 or line.find("//14.105.104") != -1 or line.find("//183.54.208.185") != -1 or line.find("//116.252.77.132") != -1 or line.find("//221.232.175") != -1 or line.find("//144.255.44.24") != -1 or line.find("//113.222.42.190") != -1 or line.find("//61.150.11") != -1 or line.find("//110.185.10") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1 or line.find("//+") != -1:    #在or后面添加更多需要删除的//xxx地址-注意冒号结尾-中间没有冒号
